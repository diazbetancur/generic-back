...
{
    /// <summary>
    /// Opciones de configuración para el servicio de API de Citas Médicas
    /// </summary>
    public class AppointmentsApiOptions : ExternalServiceOptions
    {
        /// <summary>
        ...
        /// </summary>
        public string PatientAppointmentsEndpoint { get; set; } = "/patients/{patient_id}/appointments";

        /// <summary>
        /// Endpoint para obtener citas con paginación
        /// </summary>
        public string PatientAppointmentsPaginatedEndpoint { get; set; } = "/patients/{patient_id}/appointments-with-pagination";
