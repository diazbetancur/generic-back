...
{
    /// <summary>
    /// Interfaz para el servicio de API de Hospitalizaciones
    /// </summary>
    public interface IHospitalizationsApiService
    {
        /// <summary>
        ...
        Task<HospitalizationsResponseDto?> GetPatientHospitalizationsAsync(
            string patientId,
        ...
        /// <param name="ct">Token de cancelación</param>
        Task<HospitalizationsPaginatedResponseDto?> GetPatientHospitalizationsPaginatedAsync(
            string patientId,
            int limit = 50,
            int offset = 0,
            CancellationToken ct = default);
